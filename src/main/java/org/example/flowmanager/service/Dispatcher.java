...
import org.example.flowmanager.service.processor.UploadProcessor;
...
public class Dispatcher {
    ...
    public Dispatcher(UploadProcessor uploadProcessor,
                      FailedProcessor failedProcessor,
                      DltEventProcessor dltEventProcessor) {
        this.changeProcessors = Map.of(
                ConversionStatus.PROGRESS_FILE, uploadProcessor,
